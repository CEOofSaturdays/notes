...
*Built decision-support tools for the negotiation of **$1B+ in annual contracts** using SQL Server and Power BI.*
...
* **Graduate Certificate Business Analytics** | Deakin University (Feb 2025)
* **Microsoft Certified:** Data Analyst Associate, Power Platform Functional Consultant, Azure Data Fundamentals.
* **Certificate IV in Business & Customer Engagement** | Illuminate Group
